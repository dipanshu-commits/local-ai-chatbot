...
export default function ChatPage({ theme, setTheme, isElectron }) {
    ...
    <div className="main-body">
      ...
      <div className="sidebar">
        ...
        <div className="chat-history-list">
          {chats.length === 0 && <div className="no-chats">No chats yet. Start a conversation!</div>}
          {chats.map(chat => (
            <div key={chat.id} className={`chat-history-item ${activeChatId === chat.id ? 'active' : ''}`} onClick={() => loadChat(chat)}>
